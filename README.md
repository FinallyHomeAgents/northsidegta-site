...
2. Still in Vercel, go to **Settings → Environment Variables** and verify the KV variables (`KV_URL`, `KV_REST_API_URL`, `KV_REST_API_TOKEN`, etc.) are present. Vercel adds them automatically once the store is attached.
