import localityConfig from '../../seedConfig/towns.json' with { type: 'json' }
...
export function getAllowedLocalitiesForTown(townSlug) {
...
export function extractLocalityNames(addressComponents) {
  const names = new Set()
...
export function isLocalityAllowedForTown(addressComponents, townSlug) {
