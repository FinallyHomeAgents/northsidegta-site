...
const { normalizeSpotlightTagList } = require('../../src/lib/spotlight/config.js')
...
async function loadTownSpotlightConfig(townSlug) {
...
module.exports = { loadTownSpotlightConfig }
