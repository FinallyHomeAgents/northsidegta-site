...
function main() {
  ...
  const staticRoutes = [
    ...
    { path: '/moving-to-newmarket-from-toronto', changefreq: 'monthly', priority: '0.8' },
    { path: '/moving-to-aurora-from-toronto', changefreq: 'monthly', priority: '0.8' },
    ...
    { path: '/agents/landon-mulhall', changefreq: 'yearly', priority: '0.7' },
