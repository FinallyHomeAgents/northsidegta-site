...
codex/refactor-comparisonbar-into-scoreboard-overlay-oeqwzw
...
export default function MapHero() {
 ...
 codex/refactor-comparisonbar-into-scoreboard-overlay-oeqwzw
          <div className="relative rounded-xl overflow-hidden">
            <div className="pointer-events-none absolute inset-x-0 top-4 z-30 flex justify-center px-3 sm:px-6">
              <ComparisonBar className="w-full max-w-[560px]" />
            </div>
            <div className="pointer-events-none absolute inset-x-0 top-0 z-20 h-44 bg-gradient-to-b from-emerald-950/30 via-emerald-900/15 to-transparent" />
            <div
              className="relative z-10 pt-24 sm:pt-28 md:pt-32"
