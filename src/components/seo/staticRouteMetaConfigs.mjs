...
const SEO_REMEDIATION_ROUTE_META_CONFIGS = [
  ...
  { route: "/what-my-home-buys", meta: routeMeta({ route: "/what-my-home-buys", title: "What Does My Toronto Home Buy North of the City? | NorthSide GTA", description: "Compare what your Toronto home is worth against average prices in Georgina, East Gwillimbury, Newmarket, Aurora, Stouffville, Uxbridge and Scugog \u2014 with the commute and the trade-offs.", image: HOME_IMAGE, serviceType: "Home value comparison" }) },
