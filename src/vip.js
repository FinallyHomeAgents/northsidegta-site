    ...
    return (
      ...
      >
        <form onSubmit={handlePasswordSubmit} className="bg-white bg-opacity-90 p-8 rounded-xl shadow-md max-w-md w-full">
          ...
          <p className="text-center text-gray-600 mb-6">This page is by invitation only. Please enter your password to continue.</p>
          <input
            type="password"
          ...
          />
          <button type="submit" className="w-full bg-green-600 text-white py-2 rounded hover:bg-green-700 transition">Enter</button>
        </form>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <form onSubmit={handleInfoSubmit} className="bg-gray-100 p-8 rounded-xl shadow-md max-w-md w-full">
          ...
          <p className="text-center text-gray-600 mb-6">You've been accepted into the VIP Club. Please provide your contact details to unlock your VIP perks.</p>
          <input
            type="text"
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="py-12 px-6 max-w-4xl mx-auto text-center">
        <p className="text-lg">You've been personally invited to access exclusive real estate insights, listings, and opportunities in the NorthSide GTA before the general public.</p>
      </section>
      ...
      <section className="bg-green-600 text-white py-12 px-6 text-center">
        ...
        <a href="/" className="bg-white text-green-700 font-semibold px-6 py-3 rounded-xl hover:bg-gray-100 transition">Return Home</a>
      </section>
