...
/* DAY IN LIFE */
.dil-block{background:linear-gradient(135deg,#1a4a1a12,#1a4a1a06);border-left:3px solid #1a4a1a;padding:18px 20px;border-radius:0 var(--r) var(--r) 0;font-size:13.5px;color:var(--ink2);line-height:1.8;}
/* FAQ */
...
.onemil-box{background:linear-gradient(135deg,#1a4a1a18,#1a4a1a08);border:1px solid #1a4a1a35;border-radius:var(--rl);padding:18px;margin-bottom:16px;}
...
<header class="hero" role="banner">
  <img src="/Images/stouffville-banner.jpg" alt="Stouffville Main Street" class="hero-img" loading="eager">
  <div class="hero-overlay" aria-hidden="true"></div>
  <div class="hero-content">
    <div class="hero-eyebrow">
      <img src="/assets/town-logos/stouffville.webp" alt="Stouffville NorthSide GTA town badge" class="town-badge">
    ...
    <div class="hero-stats">
      <div class="hstat"><div class="hstat-val">$1114K</div><div class="hstat-lbl">Avg. sold</div></div>
...
<div class="container">
  ...
  <div class="page-grid">
    ...
    <div>
      ...
      <!-- INTRO -->
      <div class="sec">
        <div class="sec-eyebrow">About Stouffville</div>
        <p style="font-size:14px;color:var(--ink2);line-height:1.8;">Stouffville has evolved from a quiet village into one of York Region's most active growth communities. For buyers who want newer construction, strong schools, and GO Train access without the Aurora price premium, it is a practical option — particularly for families relocating from Markham or Toronto's east end.</p>
      ...
      <div class="sec" id="neighbourhoods">
        <h2>Neighbourhoods &amp; areas in Stouffville</h2>
        <div style="margin-bottom:12px;"><span style="font-size:12px;padding:4px 11px;border-radius:8px;background:var(--gpale);border:1px solid var(--gborder);color:var(--green2);font-weight:500;display:inline-block;margin:3px 4px 3px 0;">Stouffville town</span><span style="font-size:12px;padding:4px 11px;border-radius:8px;background:var(--gpale);border:1px solid var(--gborder);color:var(--green2);font-weight:500;display:inline-block;margin:3px 4px 3px 0;">Ballantrae</span><span style="font-size:12px;padding:4px 11px;border-radius:8px;background:var(--gpale);border:1px solid var(--gborder);color:var(--green2);font-weight:500;display:inline-block;margin:3px 4px 3px 0;">Claremont</span><span style="font-size:12px;padding:4px 11px;border-radius:8px;background:var(--gpale);border:1px solid var(--gborder);color:var(--green2);font-weight:500;display:inline-block;margin:3px 4px 3px 0;">Gormley</span><span style="font-size:12px;padding:4px 11px;border-radius:8px;background:var(--gpale);border:1px solid var(--gborder);color:var(--green2);font-weight:500;display:inline-block;margin:3px 4px 3px 0;">Vandorf</span><span style="font-size:12px;padding:4px 11px;border-radius:8px;background:var(--gpale);border:1px solid var(--gborder);color:var(--green2);font-weight:500;display:inline-block;margin:3px 4px 3px 0;">Rural Whitchurch</span></div>
        <p style="font-size:13px;color:var(--ink3);line-height:1.7;">Each area within Stouffville has its own character, price range, and feel. Talk to Matthew or Landon about which sub-community fits your lifestyle and budget best.</p>
      </div>
      ...
      <tbody><tr>
      <td><div class="school-name">Stouffville District Secondary</div><div class="school-type">Public Secondary</div></td>
      <td class="school-rating">7.9/10</td>
      <td class="school-note">Fraser Institute 2024</td>
    </tr><tr>
      <td><div class="school-name">All Saints Catholic SS</div><div class="school-type">Catholic Secondary</div></td>
      <td class="school-rating">7.7/10</td>
      <td class="school-note">York Catholic District School Board</td>
    </tr><tr>
      <td><div class="school-name">Barbara Reid Public School</div><div class="school-type">Public Elementary</div></td>
      <td class="school-rating">7.7/10</td>
      <td class="school-note">Highest-rated elementary — Fraser 2024</td>
    </tr><tr>
      <td><div class="school-name">Glad Park Public School</div><div class="school-type">Public Elementary</div></td>
      <td class="school-rating">7.3/10</td>
      <td class="school-note">Fraser Institute 2024</td>
    </tr><tr>
      <td><div class="school-name">St. Mark Catholic Elementary</div><div class="school-type">Catholic Elementary</div></td>
    ...
    <p style="font-size:11px;color:var(--ink4);margin-top:10px;line-height:1.65;">Ratings from Fraser Institute Ontario School Report Cards 2024/2025. School boundaries can change — verify directly with the relevant school board before making a property decision.</p>
        <div style="margin-top:18px;">
          <h2 style="font-size:18px;margin-bottom:10px;">Commute from Stouffville</h2>
          <div style="background:var(--cream);border-radius:var(--r);padding:14px 16px;font-size:13px;color:var(--ink2);line-height:1.75;">
            <div><strong>Distance to DVP/401:</strong> 48 km</div>
            <div><strong>Off-peak drive time:</strong> approximately 40 minutes</div>
            <div><strong>Transit:</strong> GO Train (Stouffville line) — ~65 min to Union</div>
      ...
      <div class="sec" id="restaurants">
        ...
        <div class="rest-item">
      <div><div class="rest-name">Maki Japanese Restaurant</div><div class="rest-desc">AYCE sushi — well-regarded by locals</div></div>
    </div><div class="rest-item">
      <div><div class="rest-name">Cork & Barrel</div><div class="rest-desc">Wine bar on Main St</div></div>
    </div><div class="rest-item">
      <div><div class="rest-name">Ballantrae Golf & Country Club</div><div class="rest-desc">Clubhouse dining open to visitors</div></div>
    </div><div class="rest-item">
      <div><div class="rest-name">Stone Road Grille</div><div class="rest-desc">Casual neighbourhood spot</div></div>
    </div><div class="rest-item">
      <div><div class="rest-name">Main St. independent cafés</div><div class="rest-desc">Several options on the heritage strip</div></div>
      ...
      <!-- TASTEHUB -->
      <section class="th-section" aria-labelledby="th-h-stouffville">
  <div class="th-header">
    <div>
      <div class="sec-eyebrow">Community-powered local food picks</div>
      <h2 class="sec-h2" id="th-h-stouffville" style="font-size:20px;">NorthSide TasteHub Local Favourites in Stouffville</h2>
      <p class="sec-sub" style="font-size:13px;margin-top:6px;">Stouffville's Main Street and growing food scene are a major part of the lifestyle. TasteHub highlights the places locals are voting for.</p>
    ...
    <div style="display:flex;flex-direction:column;gap:8px;flex-shrink:0;">
      <a href="/tastehub?town=stouffville" class="btn-primary" style="font-size:12px;padding:9px 18px;">See Stouffville favourites</a>
      <a href="/tastehub" class="btn-secondary" style="font-size:12px;padding:8px 16px;">Vote on TasteHub</a>
    </div>
  </div>
  <div id="th-polls-stouffville" class="th-cards">
    <!-- TasteHub polls load here -->
    <div class="th-fallback">
      <p style="margin-bottom:8px;font-weight:500;">TasteHub polls for Stouffville are coming soon.</p>
      ...
      <div class="sec" id="lifestyle">
        <h2>Why people choose Stouffville</h2>
        <div class="highlight-grid"><div class="hl-item"><div class="hl-check"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div><span>Heritage Main Street</span></div><div class="hl-item"><div class="hl-check"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div><span>Ballantrae Golf & Country Club</span></div><div class="hl-item"><div class="hl-check"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div><span>Bruce's Mill Conservation Area</span></div><div class="hl-item"><div class="hl-check"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div><span>Stouffville Fairgrounds (seasonal events)</span></div><div class="hl-item"><div class="hl-check"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div><span>GO Train station</span></div><div class="hl-item"><div class="hl-check"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div><span>New subdivision parks and trails</span></div></div>
      </div>

      <!-- BUYER FIT -->
      <div class="sec" id="buyer-fit">
        <h2>Is Stouffville the right fit?</h2>
        <div class="fit-grid">
          <div class="fit-item fit-good">
            <div class="fit-label">Well suited for</div>
            <p>Young families from Markham, Richmond Hill, or Toronto's east end. New-build buyers. Buyers who want more home per dollar with GO access.</p>
          </div>
        ...
        <div style="margin-top:12px;background:var(--cream);border-radius:var(--r);padding:13px 15px;font-size:13px;color:var(--ink2);">
          <strong>Market note:</strong> Long-term value picture improves as GO service frequency increases and the town's amenity base matures. Current inventory levels provide buyer-side leverage.
        </div>
      </div>

      <!-- DAY IN LIFE -->
      <div class="sec" id="day-in-life">
        <h2>A day in Stouffville</h2>
        <div class="dil-block">Morning school drop-off near home, then the GO Stouffville line into the city — about 65 minutes to Union. The home is newer, larger, and the garage actually fits two cars comfortably. Evenings are quieter than in Aurora or Newmarket. Weekend: Bruce's Mill Conservation Area, Ballantrae Golf, a walk down Main Street on Sunday morning.</div>
      </div>
      ...
      <summary class="faq-summary">Is Stouffville a good place to live? <span class="faq-icon">+</span></summary>
      <div class="faq-answer">Stouffville combines newer homes, strong schools, GO Train access, and a heritage Main Street in a way that works well for families relocating from the inner GTA. It is one of York Region's fastest-growing communities.</div>
    </details><details class="faq-item">
      <summary class="faq-summary">What is Stouffville Ontario known for? <span class="faq-icon">+</span></summary>
      ...
      Newmarket
    </a><a href="/communities/stouffville" class="town-nav-chip current">
    ...
    <div id="contact">
      ...
      <div class="price-card">
        ...
        <div class="prow"><span class="pk">All types avg.</span><span class="pv">$1114K</span></div>
        <div class="prow"><span class="pk">Detached avg.</span><span class="pv">$1280K</span></div>
      ...
      <div class="onemil-box">
        <div class="onemil-price">What does $1M buy in Stouffville?</div>
        <p class="onemil-desc">A brand-new 4-bed, 3-bath detached in a new subdivision — typically 2,200 to 2,600 sq ft, double garage, modern finishes, unfinished basement ready to customise. Everything new, with builder selections still possible on some projects.</p>
      ...
      <div class="cta-card">
        ...
        <div class="cta-form">
          <input type="text" id="sf_name_stouffville" placeholder="Your name" autocomplete="name">
          <input type="email" id="sf_email_stouffville" placeholder="Email address" autocomplete="email">
          <input type="tel" id="sf_phone_stouffville" placeholder="Phone (optional)" autocomplete="tel">
          <select id="sf_tl_stouffville">
          ...
          <button class="cta-submit" onclick="submitTownLead('stouffville','Stouffville')">Get local guidance &rarr;</button>
        </div>
        <div class="sms-box">
          <p>Want listings for Stouffville? Get quiet text alerts.</p>
          <p style="font-size:11px;color:rgba(255,255,255,0.5);margin-bottom:8px;">No spam. Just relevant listings and local updates.</p>
          <div class="sms-row">
            <input type="tel" id="sms_stouffville" placeholder="Your phone number">
            <button class="sms-btn" onclick="submitSMSTown('stouffville','Stouffville')">Set alerts</button>
          </div>
        </div>
