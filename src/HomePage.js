        ...
        {reviews.map((r, idx) => (
          ...
          >
            <div className="flex flex-wrap items-center justify-center gap-2 mb-2">
              ...
              <span className="font-semibold text-xs sm:text-sm text-gray-700 whitespace-nowrap">Finally&nbsp;Home&nbsp;Agents</span>
...
export default function HomePage() {
  return (
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      {/* ─────────── CTA (right above the Town Strip) ─────────── */}
      <div className="mx-auto max-w-6xl px-4 mt-6 md:mt-8">
        <QuickContactCard formspreeId="your-formspree-id" />
        {/* ^^^ replace with your real Formspree ID (e.g. 'xyzabcd') */}
      </div>

      {/* ─────────── Town Strip (ordered & scrollable) ─────────── */}
